...
class Scoreboard():
    ...
    def prep_level(self):
        self.leve_image = self.font.render("LEVEL:  " + str(self.stats.level), True, self.text_color, self.ai_settings.bg_color)
